function bNao(file_in, spm, file_out, spike_list, ...
    sig_list, keep_matCmds, keep_dio, flags, messageH)
%function bNex(file_in, spm, file_out, spike_list, ...
%    sig_list, keep_matCmds, keep_dio, flags, messageH)
%
% Convenience function for building FIRA from a Nao file
% Modified from bNex, Long Ding 9/4/2015
...
bFile(file_in, 'nao', spm, file_out, spike_list, sig_list, ...
