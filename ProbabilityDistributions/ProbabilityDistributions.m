...
title(sprintf('Empirical PDF of binomial distribution, n=%d, p=%.2f, N=%d simulations', ...
   n,p,N));
xlabel(sprintf('Number of successes in %d tries', n));
ylabel('Probability');
...
for n = round(linspace(1,50,10))
   ...
   [counts,edges] = histcounts(outcomes, [xaxis-0.5 xaxis(end)+0.5]);
