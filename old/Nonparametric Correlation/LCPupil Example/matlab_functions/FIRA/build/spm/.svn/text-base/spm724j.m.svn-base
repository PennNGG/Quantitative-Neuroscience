...
if strcmp(func, 'init')
    ...
    FIRA.spm = struct( ...
        ...
        'extract', {   ...  % values to extract & save in FIRA{2}: <name> <type> <method> <args>
            ...
            'task_begin' 'time'     @getEC_time      {EC.FPONCD   1}; ...    % first fp on time
            ...
            'base'       'value'    @getEC_tagged    {8027   7000  7000  8000};              ...
        ...
        'choice'      'id';    ...  % monkey's choice
        'trg1_bdir'   'id';    ...  % binned direction of correct target
        'trg2_bdir'   'id';    ...  % binned direction of incorrect target
        'dot_dur'     'value'; ...  % dots duration
        'fix_time'    'value'; ...  % time to attain fixation
        'trg1_dir'    'value'; ...  % direction of correct target
        'trg2_dir'    'value'; ...  % direction of incorrect target        
        'sac_lat'     'value'; ...  % saccade latency
        'sac_dur'     'value'; ...  % saccade duration
        'sac_vmax'    'value'; ...  % maximum saccade velocity
        'sac_vavg'    'value'; ...  % average saccade velocity
        'sac_endrx'   'value'; ...  % saccade endpoint x
        'sac_endry'   'value'; ...  % saccade endpoint y
...
elseif strcmp(func, 'trial')
    ...
    if ~isempty(FIRA.analog.data)
        ...
        if ~isempty(sacs)
            ...
            setFIRA_ec(tti, 'sac_lat',   nans(1, 6));
        end
    end
    ...
    % get number of beeps
    %%%
    if ~isfield(FIRA, 'dio') || isempty(FIRA.dio)
        setFIRA_ec(tti, 'num_rewards' , nan);
    else
    ...
    %%%
    % get time to attain fixation
    %%%
    fix_time = getFIRA_ec(tti, 'trg_on') - getFIRA_ec(tti, 'task_begin');
...
% cleanup
    ...
    %%%
    % compute dot duration
    %%%
    FIRA.ecodes.data(:, getFIRA_ecc('dot_dur')) ...
            = FIRA.ecodes.data(:,getFIRA_ecc('dot_off'))-FIRA.ecodes.data(:,getFIRA_ecc('dot_on'));

    %%%
    % get monkey's choice in degrees
    %%%
